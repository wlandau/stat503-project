...
```{r allerr, fig.width = 9, fig.height = 10, fig.cap="\\label{fig:allerr}"}
all.err()
```

Figure \ref{fig:allerr} is the international analogue of Figure \ref{fig:misclassusa}, showing the test misclassification rates for each issue in each country. 
