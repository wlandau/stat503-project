...
```{r allerr2, fig.width = 9, fig.height = 10, fig.cap="\\label{fig:allerr2} misclassification rates for each country, faceted to compare the relative importance of key issues across countries."}
